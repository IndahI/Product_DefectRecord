...
namespace Product_DefectRecord {
    ...
    public partial class LSBUDBDataSet : global::System.Data.DataSet {
        ...
        public partial class LocationsDataTable : global::System.Data.TypedTableBase<LocationsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LocationsRow AddLocationsRow(int Id, string LocationName) {
...
namespace Product_DefectRecord.LSBUDBDataSetTableAdapters {
    ...
    public partial class LocationsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Locations] WHERE (([Id] = @Original_Id) AND ([LocationName] = " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Locations] ([Id], [LocationName]) VALUES (@Id, @LocationName);" +
                "\r\nSELECT Id, LocationName FROM Locations WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Locations] SET [Id] = @Id, [LocationName] = @LocationName WHERE (([" +
                "Id] = @Original_Id) AND ([LocationName] = @Original_LocationName));\r\nSELECT Id, " +
                "LocationName FROM Locations WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Product_DefectRecord.Properties.Settings.Default.LSBUDBConnectionString;
        }
        ...
        public virtual int Fill(LSBUDBDataSet.LocationsDataTable dataTable) {
        ...
        public virtual LSBUDBDataSet.LocationsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LSBUDBDataSet.LocationsDataTable dataTable = new LSBUDBDataSet.LocationsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LSBUDBDataSet.LocationsDataTable dataTable) {
        ...
        public virtual int Insert(int Id, string LocationName) {
        ...
        public virtual int Update(int Id, string LocationName, int Original_Id, string Original_LocationName) {
        ...
        public virtual int Update(string LocationName, int Original_Id, string Original_LocationName) {
            return this.Update(Original_Id, LocationName, Original_Id, Original_LocationName);
        }
    }
